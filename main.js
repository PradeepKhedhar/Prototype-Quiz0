...
// var homeenter = document.getElementById('home_enter')
// var category = document.getElementsByClassName('.category')
// var quiz = document.getElementById('quiz')
// var showresult= document.getElementById('result')
// var nextquestion = document.getElementById('next_question')
// var timer = document.getElementById('timer')
// var score = document.getElementById('score')


// Profit and Loss quiz section
function profit_and_loss() {
 ...
 /* function starttimer(time){
  ...
  let correct = 0,
      incorrect = 0,
      total = profitloss.length;
  //let timevalue = 60;    
  //let counter = 0;
  let questionBox = document.getElementById("question_Box");
  // let allInputs = document.querySelectorAll("li")
  //starttimer(60);
  const loadQuestion = () => {
      if (total === index) {
          //return quizEnd()
      ...
      // reset()
      const data = profitloss[index]
      questionBox.innerHTML = `${index + 1}) ${data.que}`;
     /* allInputs[0].innerText = data.a
      allInputs[1].innerText = data.b
      allInputs[2].innerText = data.c
      allInputs[3].innerText = data.d */
  }

  /*document.querySelector("#nextquestion").addEventListener(
      "click",
      function () {
...
// Enter Menu 
const quiz_page = document.getElementById('quiz');
quiz_page.style.display = "none";

const result_page= document.getElementById('result')
result_page.style.display = "none";

const quiz_selection = document.getElementById('category')
quiz_selection.style.display = "none"

const home_enter = document.getElementById('home_enter');
home_enter.addEventListener('click',
    function () {
        ...
        if(user=='')
        {
            ...
            quiz_selection.style.display = "block"           
...
const btn1 = document.getElementById('quiz1')
...
const btn2 = document.getElementById('quiz2')
...
const btn3 = document.getElementById('quiz3')
...
const btn4 = document.getElementById('quiz4')
